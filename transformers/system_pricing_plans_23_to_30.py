...
class SystemPricingPlansTransformer:
    def __init__(
    ...
    def run_transformer(self):
        ...
        self.logger.info(
            f"Starting SystemPricingPlans transformation for operator {self.operator}."
        )
            ...
            if filename.endswith(".tar.gz") or filename.endswith(".tgz"):
                ...
                with tarfile.open(input_path, "r:gz") as tar_in:
                    ...
                    with tarfile.open(output_path, "w:gz") as tar_out:
                        ...
                        # update plans[].name and plans[].description
                        if "plans" in data["data"]:
                            for plan in data["data"]["plans"]:
                                ...
                                if "description" in plan:
                                    ...
                                    plan["description"] = [
                                        {"text": description_text, "language": "en"}
                                    ]
